            ...
            <div className="form-container sign-up-container">
              <form action="#" >
                ...
                <div className="social-container">
                  <a href="www.googlo.com" className="social"><i className="fab fa-facebook-f"></i></a>
                  <a href="www.googlo.com" className="social"><i className="fab fa-google-plus-g"></i></a>
                  <a href="www.googlo.com" className="social"><i className="fab fa-linkedin-in"></i></a>
                </div>
              ...
              <div className="overlay">
                <div className="overlay-panel overlay-left">
                  ...
                  <button
                    ...
                    id="signIn"
                    onClick={function removeOverlayPane(){ document.getElementById('container').classList.remove('right-panel-active')}}>
                    Sign In
                  </button>
                </div>
                <div className="overlay-panel overlay-right">
                  ...
                  <button
                    className="ghost login__Button"
                    id="signUp"
                    onClick={function addOverlayPane(){ document.getElementById('container').classList.add('right-panel-active')}}>
                    Sign Up
                  </button>
                </div>
              </div>
